// GITHUB_REPO_URL will be configured once connected to Git.
// You can change 'your-username/portfolio' to your actual GitHub repository path.
const GITHUB_REPO_URL = 'https://github.com/your-username/portfolio';
...
export const projectsData: Project[] = [
  {
    ...
    description: 'משחק איקס עיגול קלאסי בעיצוב מודרני, נקי ויוקרתי. כולל תורות בזמן אמת וממשק מעוצב.',
  ...
  },
  {
    ...
    description: 'משחק טריוויה אינטראקטיבי מלא בעברית המבוסס על השעשועון המפורסם, כולל שאלות מרובות ברירה ומד התקדמות.',
  ...
  },
  {
    ...
    description: 'משחק התאמת קלפים קלאסי ואינטראקטיבי לאימון הזיכרון, הכולל מערכת נקודות ואפשרות לאיפוס והתחלת משחק חדש.',
  ...
  },
  {
    ...
    description: 'משחק ניחוש מילים מאתגר הכולל בחירה של אורך המילה הרצויה, מקלדת וירטואלית וציור אינטראקטיבי של האיש התלוי.',
  ...
  },
  {
    ...
    description: 'אפליקציה המציגה מידע מקיף על מדינות העולם (דגלים, ערי בירה, מטבעות) באמצעות חיבור בזמן אמת ל-REST Countries API עם יכולות חיפוש.',
  ...
  },
  {
    ...
    description: 'אפליקציה פשוטה, נקייה ויעילה לניהול משימות יומיות — הוספה, מחיקה ומעקב אחר ביצוע משימות.',
